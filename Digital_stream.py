...
MIN_STREAM_LENGTH = 1  # (!) Try changing this to 1 or 50.
MAX_STREAM_LENGTH = 5  # (!) Try changing this to 100.
PAUSE = 0.1  # (!) Try changing this to 0.0 or 2.0.
STREAM_CHARS = [' 💔-->♥️--> 💔']  # (!) Try changing this to other characters.

# Density can range from 0.0 to 1.0:
DENSITY = 0.01  # (!) Try changing this to 0.10 or 0.30.
